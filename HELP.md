...
* The following dependencies are not known to work with Spring Native: 'Spring Boot DevTools, Spring Configuration Processor, Testcontainers, Spring REST Docs, Cloud Bootstrap'. As a result, your application may not work as expected.
